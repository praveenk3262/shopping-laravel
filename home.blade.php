...
<div class="span9">		
			...
			<div class="carousel-inner">
			  ...
			  <ul class="thumbnails">
				<li class="span3">
				  <div class="thumbnail">
					<a href="{{route('Productview')}}"><img src="themes/images/products/9.jpg" alt=""></a>
					<div class="caption">
					  <h5>Product name</h5>
					  <h4><a class="btn" href="{{route('Productview')}}">VIEW</a> <span class="pull-right">$222.00</span></h4>
					</div>
				...
				<li class="span3">
				  <div class="thumbnail">
					<a href="{{route('Productview')}}"><img src="themes/images/products/10.jpg" alt=""></a>
					<div class="caption">
					  <h5>Product name</h5>
					  <h4><a class="btn" href="{{route('Productview')}}">VIEW</a> <span class="pull-right">$222.00</span></h4>
					</div>
				...
				<li class="span3">
				  <div class="thumbnail">
					<a href="{{route('Productview')}}"><img src="themes/images/products/11.jpg" alt=""></a>
					<div class="caption">
					  <h5>Product name</h5>
					   <h4><a class="btn" href="{{route('Productview')}}">VIEW</a> <span class="pull-right">$222.00</span></h4>
					</div>
				...
				<li class="span3">
				  <div class="thumbnail">
					<a href="{{route('Productview')}}"><img src="themes/images/products/1.jpg" alt=""></a>
					<div class="caption">
					  <h5>Product name</h5>
					   <h4><a class="btn" href="{{route('Productview')}}">VIEW</a> <span class="pull-right">$222.00</span></h4>
					</div>
			  ...
			  <ul class="thumbnails">
				<li class="span3">
				  <div class="thumbnail">
					<a href="{{route('Productview')}}"><img src="themes/images/products/2.jpg" alt=""></a>
					<div class="caption">
					  <h5>Product name</h5>
					  <h4><a class="btn" href="{{route('Productview')}}">VIEW</a> <span class="pull-right">$222.00</span></h4>
					</div>
				...
				<li class="span3">
				  <div class="thumbnail">
					<a href="{{route('Productview')}}"><img src="themes/images/products/3.jpg" alt=""></a>
					<div class="caption">
					  <h5>Product name</h5>
					  <h4><a class="btn" href="{{route('Productview')}}">VIEW</a> <span class="pull-right">$222.00</span></h4>
					</div>
				...
				<li class="span3">
				  <div class="thumbnail">
					<a href="{{route('Productview')}}"><img src="themes/images/products/4.jpg" alt=""></a>
					<div class="caption">
					  <h5>Product name</h5>
					   <h4><a class="btn" href="{{route('Productview')}}">VIEW</a> <span class="pull-right">$222.00</span></h4>
					</div>
